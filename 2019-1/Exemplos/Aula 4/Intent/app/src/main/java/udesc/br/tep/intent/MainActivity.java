...
public class MainActivity extends AppCompatActivity {
    ...
    // PARA TRATAR RETORNO DE PERMISSSÃO
    // https://stackoverflow.com/questions/53983248/android-permission-call-phone
    public void onRequestPermissionsResult(int requestCode,
                                           String permissions[], int[] grantResults) {
        Log.i("Permissão", "Chegou permissão do código " + requestCode);
    }
}
