...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Information", "Versão do SQLite " + sqliteversion);
        ...
        Log.i("INFORMATION","Qtd colunas: " + c.getColumnCount());
        Log.i("INFORMATION","Indice coluna nome: " + c.getColumnIndex("nome"));
        Log.i("INFORMATION","Qtd linhas: " + c.getCount());
